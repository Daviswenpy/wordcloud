...
LOGGING = {
    ...
    'handlers': {
        ...
        'debug_app': {
            ...
            'formatter': 'simple',
            # 'filename': os.path.join(LOG_PATH.rstrip('/'), 'itm_debug.log'),
            'filename': os.path.join(LOG_PATH1, 'itm_debug.log'), # modify the log save dir 20201225
            'when': 'midnight',
            'backupCount': 2
        },
        'filelog': {
            ...
            'formatter': 'simple',
            'filename': os.path.join(LOG_PATH.rstrip('/'), 'itm_error.log'), # error log save double >>> basedir & /var/...
