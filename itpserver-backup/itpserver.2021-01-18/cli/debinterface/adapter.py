...
class NetworkAdapter:
    ...
    def setBrbond(self,opts):
        """
            Set or append the bond options of an interface.
            This should be a dictionary mapping option names and values.
            In the interfaces file, options will have a 'bond' prefix.
        """

        self.validateOne('bond-opts', self._valid['bond-opts'], opts)
        self._ifAttributes['bond-opts'] = opts

    def replaceBrbond(self, key, value):
        self._ifAttributes['bond-opts'][key] = value

    def appendBrbond(self, key, value):
        self._ifAttributes['bond-opts'][key] = self._ifAttributes['bond-opts'][key] + value
    ...
    def appendPostUp(self, cmd):
        self._ifAttributes['post-up'].append(cmd)
